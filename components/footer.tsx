      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-3" aria-label="Društvene mreže">
              <a
                onClick={handleInstagram}
                aria-label="Instagram"
                className="p-2 bg-gray-800 rounded-lg hover:bg-green-600 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 group"
              >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-gray-400 text-sm sm:text-base">
              <li className="flex items-start">
                ...
                <span>Ulica Fitnesa 123<br />Beograd, Srbija</span>
              </li>
              <li className="flex items-center">
                ...
                <a href="tel:+381641234567" className="hover:text-green-500 transition-colors">
                  +381 64 123 4567
                </a>
              </li>
              <li className="flex items-center">
                ...
                <a href="mailto:luka@fitcoachpro.rs" className="hover:text-green-500 transition-colors">
                  luka@fitcoachpro.rs
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 sm:mt-12 pt-8 text-center text-gray-400 text-xs sm:text-sm">
          <p className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-1">
            ...
            <span className="flex gap-2 sm:gap-1">
              <a href="#" className="hover:text-green-500 transition-colors underline">
